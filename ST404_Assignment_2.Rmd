...
```{r Cross Validation LASSO, echo = FALSE,out.height='50%',out.width='50%', fig.cap = "Using the higher lambda includes less parameters than minimal lambda, which includes all parameters"} 
par(mfrow = c(1,1))
...
```{r, echo = FALSE, fig.width=9 , fig.height=2.25, fig.cap = "Residuals vs Fitted and Scale-Location Plots demonstrate no undesirable patters"}
