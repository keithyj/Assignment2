...
```
alsdfkjkdfjklajdfkljaskdfjkadjfkjakdjfkajdkfadsjflkajdsfjksajksjkfjlsdfkljdkfjsdfkljsdkfksdjfklajsdfjajsdfjkldjfljdsajfksjkldjjasljlfjasdakjsdnfadsklfjdjsfkjaskfjd

```{r, echo = FALSE}
par(mfrow = c(2,1), mar = c(1.8,4.4,2,1.8))
bin <- scale(LASSOresiduals)
bin1 <- which(bin < 0)
bin[bin1] <- -bin[bin1]
plot(LASSOpredicted, sqrt(bin), main = "Scale Location For LASSO model", xlab = "Fitted values", ylab = "Square Root of Standardised Residuals")
