...
This model has a R squared value of 0.4678.
We then attempted to extend this model using quadratic terms and interaction terms between highly correlated variables. However the interaction terms were not being included and the quadratic terms whcih were included would shrink their linear counterparts to zero. Hence we leave 
