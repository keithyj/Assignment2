...
Observations 2682, 282, 166, 2727, and 2714 appear to be problematic appearing as high leverage, high outliers and also being influencial observations as shown by the DFBETAS > 0.4 we will declare this to be highly influencial and so remove these observations from our model.

``` {r removeoutliers, include = FALSE}
library(dplyr)
cancer5 <-  slice(cancer5, -c(2682, 282, 166, 2727, 2714))
```
